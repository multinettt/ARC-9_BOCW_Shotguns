...
ATT.PrintName = "STANAG 12 Rnd Tube" --// 2
ATT.CompactName = "12 RND"
ATT.Icon = Material("entities/bocw_atts/magazines/gallosa12_extpro.png", "mips smooth")
ATT.Description = [[Extended tube magazine holds five additional shells.
...
ATT.ClipSizeMult = 1.71

ATT.ReloadTimeMult = 0.66
