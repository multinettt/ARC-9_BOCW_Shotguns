...
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_speed.png", "mips smooth")
...
ATT.Category = "bocw_gallosa12_wrap"

ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_speed.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_speed")

ATT = {}

ATT.PrintName = "Dropshot Wrap" --// 2
ATT.CompactName = "DRPSHT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_dropshot.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_dropshot.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_dropshot")

ATT = {}

ATT.PrintName = "Field Tape" --// 3
ATT.CompactName = "FIELD TAPE"
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_fieldtape.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_fieldtape.mdl"

ATT.Scale = 1
ATT.ModelOffset = Vector(0, 0, 0)
ATT.ModelAngleOffset = Angle(0, 0, 0)

ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_fieldtape")

ATT = {}

ATT.PrintName = "SASR Jungle Grip" --// 4
ATT.CompactName = "SASR GRP"
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_sasrjungle.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_sasrjungle.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_sasrjungle")

ATT = {}

ATT.PrintName = "Serpent Wrap" --// 5
ATT.CompactName = "SRPNT WRP"
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_serpent.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_serpent.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_serpent")

ATT = {}

ATT.PrintName = "Airborne Elastic Wrap" --// 6
ATT.CompactName = "AIRBRN WRP"
ATT.Icon = Material("entities/bocw_atts/handles/gallosa12_airborne.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_gallosa12_handle_airborne.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_gallosa12_handle_airborne")
...
ATT.Category = {"bocw_gallosa12_triggerguard"}

ATT.MenuCategory = "ARC9 - BOCW Attachments"

ATT.ActivateElements = {"triggerguardgone"}

ARC9.LoadAttachment(ATT, "bocw_gallosa12_triggerguard_removed")